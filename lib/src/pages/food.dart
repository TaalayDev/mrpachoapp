                          ...
                          child: Padding(
                            ...
                            child: Wrap(
                              ...
                              children: [
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color: _con.food.deliverable ? Colors.green : Colors.orange, borderRadius: BorderRadius.circular(24)),
                                    ...
                                    Container(
                                        ...
                                        child: Text(
                                          _con.food.capacity + " " + _con.food.unit,
                                          style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                        )),
                                    SizedBox(width: 5),
                                    Container(
                                ...
                                /*
                                _con.food.optionGroups == null
                                    ? CircularLoadingWidget(height: 100)
                                    : ListView.separated(
                                        padding: EdgeInsets.all(0),
                                        itemBuilder: (context, optionGroupIndex) {
                                          var optionGroup = _con.food.optionGroups.elementAt(optionGroupIndex);
                                          return Wrap(
                                            children: <Widget>[
                                              ListTile(
                                                dense: true,
                                              ...
                                              ListView.separated(
                                                ...
                                                itemBuilder: (context, optionIndex) {
                                                  return OptionItemWidget(
                                                    option:
                                                        _con.food.options.where((option) => option.optionGroupId == optionGroup.id).elementAt(optionIndex),
                                                ...
                                                itemCount: _con.food.options.where((option) => option.optionGroupId == optionGroup.id).length,
                                                primary: false,
                                                shrinkWrap: true,
                                              ),
                                            ],
                                        ...
                                        itemCount: _con.food.optionGroups.length,
                                        primary: false,
                                        shrinkWrap: true,
                                      ),
                                ListTile(
                                ...
                                Stack(
                                  ...
                                  children: <Widget>[
                                    SizedBox(
                                      ...
                                      child: FlatButton(
                                        onPressed: () {
                                          if (_con.isSameMarkets(_con.food)) {
