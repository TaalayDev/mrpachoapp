...
InputDecoration getInputDecoration(context, {String hintText, String labelText}) {
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new TextFormField(
                        ...
                        decoration: getInputDecoration(context, hintText: S.of(context).home_address, labelText: S.of(context).description),
                        initialValue: address.description?.isNotEmpty ?? false ? address.description : null,
                        validator: (input) => input.trim().length == 0 ? 'Неправильное описание' : null,
                    ...
                    Padding(
                      ...
                      child: new TextFormField(
                        style: TextStyle(color: Theme.of(context).hintColor),
                        keyboardType: TextInputType.text,
                        decoration: getInputDecoration(context, hintText: S.of(context).hint_full_address, labelText: S.of(context).full_address),
                        initialValue: address.address?.isNotEmpty ?? false ? address.address : null,
                        validator: (input) => input.trim().length == 0 ? 'Неправильный адрес' : null,
                    ...
                    SizedBox(
                      ...
                      child: CheckboxFormField(
                        ...
                        title: Text('Сделать по умолчанию'),
                      ),
                    )
                  ],
                ),
