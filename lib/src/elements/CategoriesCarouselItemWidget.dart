...
class CategoriesCarouselItemWidget extends StatelessWidget {
  ...
  Function onTap;
  String heroTag;
  CategoriesCarouselItemWidget({Key key, this.marginLeft, this.category, this.onTap, this.heroTag}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        ...
        else Navigator.of(context).pushNamed('/Category', arguments: RouteArgument(id: category.id));
      },
      child: Column(
